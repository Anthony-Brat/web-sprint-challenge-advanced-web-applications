...
Tokens are use to handle authentication between and server and a client by preventing unauthorized users from accessing protected data.

2. What steps can you take in your web apps to keep your data secure?
Use protected routes and authentication.

3. Describe how web servers work.
Web servers are computers that have web server software with their main purposing being to serve web pages.
